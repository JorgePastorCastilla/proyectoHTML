        ...
        <html>
            <head>
                ...
                <style>
                    *{
                    ...
                    .articulo{ height: 210px;padding-left: 2%; padding-top: 20px;padding-bottom: 10px;border-bottom: solid 2px;}
                    .articulo-imagen{width: 110px;height: 156px;display: inline-block;}
            ...
            <body>
                ...
                <main id="mainid" class="col-12 col-12m col-12s">
                    <!--<div style="width: 12.5%;display: inline-block;"></div>
